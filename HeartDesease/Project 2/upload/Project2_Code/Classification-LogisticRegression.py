...
lambda_interval = np.logspace(-5, 3, 10)
...
plt.text(1e-4, 14, "Test error: " + str(np.round(min_error*100,2)) + ' % at 1e' + str(np.round(np.log10(opt_lambda),2)))
plt.text(1e-4, 13, "Accuracy : " + str(np.round(100-min_error*100,2)) + ' % at 1e' + str(np.round(np.log10(opt_lambda),2)))
...
print(classification_report(y_test,y_test_est))
